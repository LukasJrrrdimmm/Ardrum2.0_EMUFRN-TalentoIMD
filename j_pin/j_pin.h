...
#define P_CAIXA = (1 << ADC1);
#define P_ARO  = (1 << ADC2);
#define P_BUMBO  = (1 << ADC3);
#define P_CHIMBAL = (1 << DC7);
#define DP_HHC = (1 << ADC0);
#define P_RIDE = (1 << ADC8);
#define P_TOM1 = (1 << ADC4);
#define P_TOM2 = (1 << ADC5);
#define P_TOM3 = (1 << ADC10);
#define P_ATAQUE = (1 << ADC6);
#define P_ATAQUE2 = (1 << ADC9);
